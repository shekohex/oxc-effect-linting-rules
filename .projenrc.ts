...
const devReleaseWorkflowPath = ".github/workflows/dev-release.yml";
const devReleaseWorkflow = `# ~~ Generated by projen. To modify, edit .projenrc.js and run "npx projen".
...
fs.writeFileSync(devReleaseWorkflowPath, devReleaseWorkflow);
